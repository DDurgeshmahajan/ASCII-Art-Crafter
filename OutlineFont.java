/**
 * Implements an ASCII art font with an 'Outline' style.
 * Each character is rendered using '.' for outlines and ' ' for empty areas.
 */
public class OutlineFont extends AsciiFont {
    ...
    protected void populateFontMap() {
        ...
        // Symbols (Many symbols are identical to BlockFont for simplicity)
